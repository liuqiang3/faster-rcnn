...
class Dataset(imdb):
  def __init__(self, imdb_names, image_set, use_diff=False):
    name = imdb_names + '_' + image_set
    if use_diff:
      name += '_diff'
    imdb.__init__(self, name)
    self._image_set = image_set
    self.imdb_names = imdb_names
    self._devkit_path = self._get_default_path()
    self._data_path = os.path.join(self._devkit_path, imdb_names)
  ...
  def _get_default_path(self):
    ...
    """
    return os.path.join(cfg.DATA_DIR, 'my_data')
